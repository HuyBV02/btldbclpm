...
const OpenSavingsBook = (props) => {
    ...
    const handleChange = (e) => {
        ...
        formInputs.forEach(input => input.addEventListener('keypress', handleEnterKeyPress));

        // Xóa lắng nghe sự kiện khi component bị hủy
        return () => {
            formInputs.forEach(input => input.removeEventListener('keypress', handleEnterKeyPress));
        };
    }, [handleSubmit]);
            ...
            <div className='khung'>
                ...
                <form onSubmit={handleSubmit} className="form-container">
                    ...
                    <div className="form-group">
                        <label>Số tiền:</label>
                        <input className='input-nhap' type="text" name="amount" value={formData.amount} onChange={handleChange} />
                    </div>
                    <div className="form-group">
